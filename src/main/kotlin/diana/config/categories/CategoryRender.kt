...
object CategoryRender : Category("Render") {
    ...
    var guessSeparateColor by boolean("Interpolation", true).apply { description = "Changes of the location of the guess will smooth." }.apply { description = "If the guess burrow should have its own color." }
    ...
    var unknownColor by color("Unknown Color", Color.WHITE).apply { description = "The color of an unknown (usually mob/treasure) burrow (typically the third, before the mod has gathered enough info)." }
